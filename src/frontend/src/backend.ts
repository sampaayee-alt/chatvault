...
export class Backend implements backendInterface {
    ...
    async fetchUrlContent(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchUrlContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTotalExports(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalExports();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveChatSession(arg0: ChatSessionInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveChatSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
